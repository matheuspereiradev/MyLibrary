...
<html lang="en">
    ...
    <head>
        ...
        <title>ML- Cadastrar amigo</title>
...
<li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Adicionar novo amigo</h1>
                        <form action="../classesPhp/addAmigo.php" method="post">
                            <label for="nome">Nome:(O nome deve ser único para identificar seu amigo) </label>
                            <br>
                            <input type="text" name="nome" id="nome" maxlength="45" class="form-control" placeholder="nome" autofocus required>

                            <br>
                            <label for="telefone">telefone: </label>
                            <br>
                            <input type="text" name="telefone" id="telefone" maxlength="11" class="form-control" placeholder="telefone">
                            ...
                            <center><input type="submit" class="btn btn-primary btn-lg" value="Cadastrar amigo"></center>
                        </form>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
