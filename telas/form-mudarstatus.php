...
<li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Alterar status de leitura</h1>
                        <!--conteudo-->
                        <!-- Começo aviso -->
                        <div >
                            <div class="panel panel-red">
                                ...
                                <div class="panel-body">
                                    <ul style="list-style-type:disc">
                                        <li>Após alterar o status de leitura clique no botão salvar</li>
                                        <li>Após retirar o livro do status de "não lido" e salva a ação, não será possível voltar para o status de "não lido"</li>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($livro = $stmtlista->fetch(PDO::FETCH_ASSOC)): ?>
                                        <tr class="even gradeC">
                                            ...
                                            <td><?php if ($livro['statusEmprestimo'] == 0) {
                                            echo "Não emprestado";
                                        } else {
                                            echo "Emprestado";
                                        } ?></td>
                                            <!--STATUS DE LEITURA DEVE SER IGUAL AO CADSATRO-->
                                    <form action="../classesPhp/mudastatus.php" method="post">

                                        <td><div class="form-group">
        <?php if ($livro['statusLeitura'] == 1): ?>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="statusLeitura" id="1" value="1" checked>Não lido
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="statusLeitura" id="2" value="2">Lendo
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="statusLeitura" id="3" value="3">Lido
                                                    </label>
                                                </div>
        <?php endif ?>
        <?php if ($livro['statusLeitura'] == 2): ?>
                                                <label class="radio-inline">
                                                    <input type="radio" name="statusLeitura" id="1" value="1" disabled>Não lido
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="statusLeitura" id="2" value="2" checked>Lendo
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="statusLeitura" id="3" value="3">Lido
                                                </label>
        ...
        <?php if ($livro['statusLeitura'] == 3): ?>
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="statusLeitura" id="3" value="3" checked>Lido
                                                </label>
                                                </div>
        <?php endif ?>
                                        </td>
                                        ...
                                        <TD><input type="submit" value="salvar" class="btn btn-outline btn-default btn-lg btn-block"></TD>
