...
$idLivro = isset($_POST['idLivro']) ? (int) $_POST['idLivro'] : null;
...
<li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Editar informações do livro</h1>
                        <form action="../classesPhp/editLivro.php" method="post">
                            <label for="nome">Nome: </label>
                            <br>
                            <input type="text" name="nome" id="nome" value="<?php echo $livro['nome'] ?>" required maxlength="100" class="form-control" placeholder="nome" autofocus>

                            <br><br>

                            <label for="autor">Autor: </label>
                            <br>
                            <input type="text" name="autor" id="autor" value="<?php echo $livro['autor'] ?>" required maxlength="45" class="form-control" placeholder="nome">

                            <br><br>
                            <input type="hidden" name="data" value="<?php echo $livro['data'] ?>">
                            <input type="hidden" name="statusLeitura" value="<?php echo $livro['statusLeitura'] ?>">
                            <input type="hidden" name="statusEmprestimo" value="<?php echo $livro['statusEmprestimo'] ?>">
                            <input type="hidden" name="Usuario_id_usr" value="<?php echo $livro['Usuario_id_usr'] ?>">
                            <input type="hidden" name="idLivro" value="<?php echo $livro['idLivro'] ?>">
                            <center><input type="submit" class="btn btn-primary btn-lg" value="Editar livro"></center>
                        </form> 
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
